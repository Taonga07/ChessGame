...
if [ "${machine}" = "Linux" ]; then
    ...
    pyinstaller ../ChessGame/Main.py --onefile -w --windowed --noconsole --icon="../ChessGame/Chess_Ressources/Icon.png" --add-data="/home/taonga07/Documents/DigiLocal/Chess2030/ChessGame*:."
    BASEDIR=$(pwd $0)
    ...
    echo "Icon="$BASEDIR"Chess_Resources/Icon.png" >> ~/.local/share/applications/Chess2030.desktop
